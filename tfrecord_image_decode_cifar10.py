...
tf.app.flags.DEFINE_string(
    'dataset_dir', "/home/robin/Dataset/cifar10", 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
    'preprocessing_name', "cifarnet", 'The name of the preprocessing to use. If left '
