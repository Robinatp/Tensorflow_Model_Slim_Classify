...
def shufflenet_v1(inputs,
    ...
    blocks =  [
        ...
        shufflenet_block('Stage2', base_depth=base_depths[0], num_units=4,
                         stride=2, groups=groups, groups_in=1),#groups_in=1
        shufflenet_block('Stage3', base_depth=base_depths[1], num_units=8,
                         stride=2, groups=groups),
        shufflenet_block('Stage4', base_depth=base_depths[2], num_units=4,
                         stride=2, groups=groups),
    ]
